...
async def command_start(message: Message):
    ...
    # await echo(message)     # выполнятеся функция с передаными сообщениями (start)
    await FSWaitAnswer.waiting_for_agree.set()
    # await message.answer('после StateGroups')
